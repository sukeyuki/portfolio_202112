...
* impression<br>
&emsp;プライベート、仕事、個人的な予定を全て管理できるスケジュールアプリを目指し、本webアプリを作成しました。作成者にとって初めて作ったwebアプリとなります。<br>
苦労した点は、同時刻のスケジュールを画面に表示する際、重ならないように表示する点です。<br>
課題は、ドラッグ、ドロップを用いた直感的な操作、参加不参加機能の実装です。
...
* １週間の予定を表示します。
* スケジュールはグループに登録されます。<br>
グループに所属しているユーザーで、そのグループに登録されたスケジュールを共有します。
* 画面に表示するスケジュールを、グループ毎に選択する事が出来ます。
...
* [グループ概要](#グループ概要)
  * [グループの作成](#グループの作成)
  * [グループの編集画面への遷移](#グループの編集画面への遷移)
  * [グループ編集：招待](#グループ編集招待)
  * [グループ編集：権限編集、追い出し](#グループ編集権限編集追い出し)
  * [グループ編集：グループ参加](#グループ編集グループ参加)
* [スケジュール概要](#スケジュール概要)
  * [スケジュール作成](#スケジュール作成)
  * [スケジュール詳細表示](#スケジュール詳細表示)
  * [スケジュール編集、削除](#スケジュール編集削除)
* [表示切り替え](#表示切り替え)
...
グループの管理者はグループの編集を行う事が出来ます。

* グループには1人以上の管理者が必要です。<br>
グループ作成時にグループ作成者がグループの管理者となります。

* 個人的な予定はprivateグループに登録して下さい。<br>
privateグループはユーザー登録時に自動的に作成されます。<br>
...
※自分がグループの管理者ではない場合、グループeditページへ遷移できません。<br>
...
## グループ編集：招待
グループ編集画面に遷移します。（遷移方法は右記参照： [グループの編集画面への遷移](#グループの編集画面への遷移))<br>
...
* スケジュールの作成、編集、削除はグループに所属しているユーザーならその権限に関係なく可能です。
* 個人的な予定はprivateグループに登録して下さい。<br>
